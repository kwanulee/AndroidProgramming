...
1. TablePhoneFragment 프로젝트를 생성한다.
	- 패키지 이름: *com.android.tabletphonefragment*
...
6. **TitlesFragment.java** 
	- **onCreateView()** 메소드 안에서 **fragment\_titles.xml** 파일을 인플레이션 함
	- **ArrayAdapter** 객체를 생성하고, **fragment\_titles.xml**에 포함된 ListView 객체에 **setAdapter()** 메소드를 통해 설정함
